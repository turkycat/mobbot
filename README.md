...
mobbot is a chat bot built on the [Hubot][hubot] framework. It was
...
You can start mobbot locally by running:
...
Then you can interact with mobbot by typing `mobbot help`.

    mobbot> mobbot help
    mobbot animate me <query> - The same thing as `image me`, except adds [snip]
    mobbot help - Displays all of the help commands that mobbot knows about.
    ...
